...
function getDueWarningClass(days) {
    if (days === null) return '';
    if (days < 0) return 'text-red-300 font-bold'; // Vencida
    if (days <= 3) return 'text-red-300 font-bold animate-pulse'; // Crítico
    if (days <= 7) return 'text-yellow-300 font-bold'; // Alerta
