    ...
    <div class="flex min-h-screen">
        ...
        >
            <div class="flex flex-col h-full">
                <!-- Logo -->
                <div class="flex items-center gap-3 h-16 px-6 border-b border-gray-200 dark:border-gray-800">
                    ...
                    <span class="text-xl font-bold text-gray-900 dark:text-white">FinançasPro</span>
                </div>
                ...
                <div class="p-4 border-t border-gray-200 dark:border-gray-800">
                    <div class="flex items-center gap-3 mb-3">
                        <div class="w-10 h-10 rounded-full bg-gray-200 dark:bg-gray-700 flex items-center justify-center">
                            <span class="text-gray-700 dark:text-white font-medium">{{ userInitials }}</span>
                        </div>
                    ...
                    <button
                        @click="handleLogout"
                        class="w-full flex items-center gap-2 px-3 py-2 text-sm text-gray-600 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-800 hover:text-gray-900 dark:hover:text-white rounded-lg transition-colors"
                    >
...
const navigation = [
    ...
    { name: 'Insights', to: '/insights', icon: InsightsIcon },
    { name: 'Calendário', to: '/calendar', icon: CalendarIcon },
    { name: 'Gráficos', to: '/charts', icon: ChartsIcon },
